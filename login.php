...
<head>
    ...
    <title>UO! | MAKE EXAMINATION EASIER</title>
...
<body class="login">
    <div>
        ...
        <div class="login_wrapper">
            ...
            <div id="register" method="post" class="animate form registration_form">
                <section class="login_content">
                    <form>
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary submit">Register Account</button>
                        </div>
